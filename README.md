...
Qubes-Snitch intentionally rejects IDN, punycode, and other Unicode DNS names in live DNS prompts and manual DNS policy. This keeps DNS allow/reject decisions readable and avoids homograph lookalikes such as раураl.com, gооgle.com, and аррӏе.com.
