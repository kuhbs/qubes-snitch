...
install -d -m 0755 /etc/qubes-snitch /rw/usrlocal/qubes-snitch/rules /usr/lib/python3/dist-packages/qubes_snitch /usr/lib/qubes-snitch /usr/share/applications
